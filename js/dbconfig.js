...
const propertyPath = path.join(__dirname, '../../database/db.properties')
const properties = propertiesReader(propertyPath);

var username = properties.get('userid');
var password = properties.get('password');
var connectString = properties.get('dburl').split("//")[1];
